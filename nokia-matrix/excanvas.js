...
if(((navigator.appName.search(/explorer/i) != -1) || (/MSIE/.test(navigator.userAgent)))&&!window.opera){
...
var W=10;
var H=10;
vmlStr.push(' <g_vml_:group',' coordsize="',Z*W,',',Z*H,'"',' coordorigin="0,0"',' style="width:',W,';height:',H,';position:absolute;');
...
var tag="image"
vmlStr.push(' ">','<g_vml_:',tag,' src="',image.src,'"',' style="width:',Z*dw,';;',' height:',Z*dh,';"',' cropleft="',sx/w,'"',' croptop="',sy/h,'"',' cropright="',(w-sx-sw)/w,'"',' cropbottom="',(h-sy-sh)/h,'"',
' >','</v:',tag,'>','</g_vml_:group>');
...
var W=10;
var H=10;
lineStr.push('<g_vml_:shape',' filled="',!!aFill,'"',' style="position:absolute;width:',W,';height:',H,';"',' coordorigin="0 0" coordsize="',Z*W,' ',Z*H,'"',' stroked="',!aFill,'"',' path="');
var newSeq=false;
...
' position="',0,',',0,'"',' type="','tile','"',' src="',this.fillStyle.src,'" />');
}
else
{
