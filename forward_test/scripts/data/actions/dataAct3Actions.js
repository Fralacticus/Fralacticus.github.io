...
define([''], function() {
    ...
    var dataAct3Actions = {
        ...
        healSummoner: {
            ...
            data: [
                ['wait', 90],
                ['addReaction', '@SUMMONER', 'wardHealingState'],
                ['setAnim', 'shine'],
                ['wait', 4],
                ['advanceFrame'],
                ['repeatPhase', 3, {
        ...
        wardHealingState: {
            ...
            data: [
                ['addState', ['wardHealing', {
                    stats: [
                        ['hpr', 25]
                    ]
                }]],
                ['wait', 180],
                ['removeState', 'wardHealing']
            ]
        },
        summonExplosiveWard: {
            data: [
        ...
        takeoff: {
            ...
            data: [
                ['jump', 0.6],
                ['wait', 4],
                ['setVariable', 'floating', true],
                ['setVariable', 'gravity', false],
                ['jump', 0],
                ['setDirection', 'TOWARDS_PLAYER'],
                ['setFrame', 'emerge:0'],
                ['wait', 4],
        ...
        rockbigThrow: {
            ...
            data: [
                ...
                ['setFrame', 'idle:0'],
                ['wait', 4],
                ['conditionalWait', 5, function(game, entity) {
        ...
        bloomShatter: {
            ...
            data: [
                ['combatSetupCamera', 42 * 16 - 2, 16 * 16],
                ['setTimer', '@CHARACTER', 'relish', 60],
                ['move', '@CHARACTER', 'RIGHT', 0],
                ['setAnim', 'shatter'],
                ['advanceFrame'],
                ['performHit'],
                ['wait', 4],
